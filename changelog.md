...
- It is up to Carmen's DevOps teams to convert their infrastructure data in Carmen's input file. TODO: See [[docs-requirements]] for more information.
- It is up to Carmen's DevOps teams to convert the output in a graphical interface.

- This release enables Carmen to be platform/environment agnostic: one can chose to run Carmen to measure CO2 impact of bare-metal servers, own-premise data center, Cloud deployed infrastructure, a mix of all, etc.
...
- Current implementation supports "local" infrastructure (aka own-premise) and Microsoft Azure.
